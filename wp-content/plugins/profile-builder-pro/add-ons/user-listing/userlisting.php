    ...
    foreach ( $userlisting_themes as $theme ) {
        ...
        $output .= '<div id="modal-reset-'. $theme['id'] .'" class="wppb-ul-theme-reset-modal" title="Reset '. $theme['name'] .' Theme Settings">
                            <div class="wppb-reset-modal-content">
                                ...
                                <p class="notice-content cozmoslabs-description"><strong>Note:</strong> The settings on the page will be replaced with your active User-Listing Theme\'s Default settings, according to your choice from the options above.</p>
                            </div>
